...
// Initail Running
jQuery('select').selectric({maxHeight:200,disableOnMobile:false});

// Destroy Element where need
jQuery('.woocommerce-checkout .content-sec select , #commentform select').selectric('destroy');

// For Currncy and Language selector
jQuery('.language-switcher select').selectric({
