...
jQuery( document ).ready( function ( $ ) {
	...
	/* global wc_moneris_hosted_tokenization_params, wc_checkout_params */
	...
	function hostedTokenizationRequest( $form ) {
		...
		$( '#wc-moneris-account-number' )[0].contentWindow.postMessage( '', wc_moneris_hosted_tokenization_params.hosted_tokenization_url );
	}
